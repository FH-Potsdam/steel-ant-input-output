...
// names.forEach(function(element, i, array) {
  ...
  for (var i = 0; i < names.length -1; i++){
    ...
    execSync(
      'ghi open "update algorithm and create microsite" -u ' + names[i] + ' --milestone 2 --label task -m "just create a new repo with your sketch.js and a i.html. After that create a branch called gh-pages. Your microsite should then be availabale under http://YOUR-USER-NAME.github.io/YOUR-REPO-NAME"', {
        encoding: 'utf8',
        stdio: [0, 1, 2]
      }
    );
